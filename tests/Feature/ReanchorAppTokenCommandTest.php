...
class ReanchorAppTokenCommandTest extends TestCase
{
     ...
     *
     * Гонка не гипотетическая: живой вызов идёт по шине appEvents, слушатель которой
     * сохраняет обновлённый токен прямо в b24_apps, и слепой откат вернул бы туда уже
     * отозванное Битриксом значение.
     */
