...
/**
 * Проба установки: диспетчер событий, которым пользуется вызов «кто ставит приложение?».
 *
 * Проба идёт ДО проверки админства, поэтому её диспетчер не должен уметь писать в b24_apps.
