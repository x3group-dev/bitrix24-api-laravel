 ...
 * одного пути молча сошёл бы за оба.
 *
 * Это страховка от расхождения путей, а не замена поведенческим тестам. Комментарии
 * вырезаются, чтобы проверка ловила код, а не пояснения к нему.
 */
