...
return [
     ...
     *
     * grant_entity_rights — после перехода на системного пользователя выдать ему право X
     * на все сущности entity.*. Нужно приложениям, которые хранят данные в entity-сущностях:
