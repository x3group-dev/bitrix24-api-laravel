 ...
 *
 * Обоснование модели владения — docs/superpowers/specs/2026-07-28-app-token-owner-design.md.
 */
class ReanchorAppTokenCommand extends Command
{
    ...
    private function reanchor(B24App $b24app, B24User $admin): array
    {
        ...
        // по шине appEvents, слушатель которой сохраняет обновлённый токен прямо в
        // b24_apps, и безусловный откат затёр бы его уже отозванным значением.
