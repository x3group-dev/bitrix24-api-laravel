...
/**
 * Диспетчер событий для ПРОБНОГО вызова установки — того, которым выясняют, кто ставит
 * приложение.
 *
 * Проба идёт до проверки админства, поэтому её диспетчер НЕ несёт слушателя «записать
