 ...
 *
 * Оба пути устроены в два клиента: сначала ПРОБА («кто ставит?») на шине
 * {@see InstallTokenProbe} без слушателей, пишущих в БД, затем — уже после гейта — РАБОЧИЙ
 * клиент на шине 'appEvents', чей рефреш на длинном хвосте установки обязан сохраниться.
 *
...
class InstallService
{
    ...
    public function handleOnAppInstall(Request $request): void
    {
        ...
        // Проба на той же изолированной шине, что и на install-странице: до гейта запись в
        // b24_apps не должна быть возможна.
        $probe = new InstallTokenProbe();
